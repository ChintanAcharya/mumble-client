...
class ChannelListItem extends StatefulWidget {
  ...
  const ChannelListItem(
      {required this.channelName, Key? key, this.active = false})
      : super(key: key);
          ...
          style: ButtonStyle(
            ...
            foregroundColor: MaterialStateProperty.resolveWith<Color?>(
              ...
              if (states.contains(MaterialState.hovered) ||
                  states.contains(MaterialState.focused) ||
                  states.contains(MaterialState.pressed) ||
                  widget.active) return Colors.grey[800];
...
class ChannelMemberList extends StatelessWidget {
  const ChannelMemberList({Key? key}) : super(key: key);
      ...
      style: ButtonStyle(
        ...
        foregroundColor: MaterialStateProperty.resolveWith<Color?>(
          ...
          if (states.contains(MaterialState.hovered) ||
              states.contains(MaterialState.focused) ||
              states.contains(MaterialState.pressed) ||
              speaking) return Colors.grey[800];
          return Colors.grey[600];
        }),
        overlayColor: MaterialStateProperty.all(Colors.transparent),
        textStyle: MaterialStateProperty.all(
